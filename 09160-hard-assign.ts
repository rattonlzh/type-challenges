...
// ============= Your Code Here =============
type Assign<T extends Record<string, unknown>, U> = (U extends [infer F extends Record<string, unknown>, ...infer R] ? Assign<{
  [P in (keyof T) | (keyof F)]: P extends keyof F ? F[P] : P extends keyof T ? T[P] : never
}, R> : T) extends infer Res ? Res : never

let a: Assign<Case3Target, [Case3Origin1, Case3Origin2]>
//  ^?
