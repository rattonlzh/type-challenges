...
type RemoveIndexSignature<T> = {
  [K in keyof T as  IsNever<Extract<string | number | symbol, K>> extends true ? K : never]: T[K]
}
...
let xx: GetRootTagObject<Tag<Tag<'', 'A'>, 'B'>>
...
type UnTag<B> = {
  [P in keyof B as Exclude<P, US>]: B[P]
}
...
type HasTags<
  ...
  U extends string[] = GetTags<B> extends string[] ? GetTags<B> : never
> = U extends [...T, ...unknown[]]
  ? true
  : U extends [...unknown[], ...T]
  ? true
